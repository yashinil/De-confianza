  ...
  <div class="wheel closed">
      <ul>
        <li>
          ...
          <input type="text" placeholder="NAME" tabindex="1" required name="name">
        </li>
        <li>
          <input type="email" placeholder="EMAIL" tabindex="2" required name="email">
        </li>
        <li>
          <input type="number" placeholder="CONTACT" tabindex="3" required name="contact" id="contact" maxlength="10">
        </li>
        <li>
          <input type="text" placeholder="USERNAME" tabindex="4" required name="username">
        </li>
        <li>
          <input type="password" placeholder="PASSWORD" tabindex="5" required name="password" id="password">
        </li>
        <li>
          <input type="password" placeholder="CONFIRM PASSWORD" tabindex="6" required name="confirm_password" id="confirm_password">
        </li>
        <li>
          <input placeholder="SUPPLIER OR CUSTOMER??" tabindex="7" type="text" name="category" id="category" required>
        </li>
        <li>
          <input placeholder="COUNTRY" tabindex="8" required name="country" type="text">
        </li>
      </ul>
      <input type="submit">
    </form>
...
var b='customer';
function validate(){
	if(category.value==a || category.value==b)
	{
		category.setCustomValidity('');
	}
	else
	{
		category.setCustomValidity("Your category should be either supplier or customer!!");
	}
}
